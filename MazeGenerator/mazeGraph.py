# mazeGraph.py - holds a class that holds the functionality to generate a
# graph consistent with properties of a maze, and suitable for the maze algorithm.
...
class MazeGraph():
    ...
    def initConnections(self):
        ...
        for vertexID in range(maxVertexID):
            ...
            updateBar = random.randint(0, self.progressBar.updateFreq)
            if not self.graph.displayDetail and updateBar == 0:
                self.progressBar.displayAddWeightsProgress(progress)
